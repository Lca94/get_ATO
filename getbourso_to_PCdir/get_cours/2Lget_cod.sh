...
find -name \.${COD}\*csv -mtime +0 -exec gzip {} \;
...
sync
sleep .2
#curl -o ${COD}.html https://www.boursorama.com/cours/1rP${COD}/_toutes-les-transactions?limit=2000o
curl -o ${COD}.html https://www.boursorama.com/cours/${COD}/_toutes-les-transactions?limit=2000o
sync
sleep .2
